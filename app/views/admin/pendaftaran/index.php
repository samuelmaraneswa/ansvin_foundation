<div class="calon-siswa-container">
  <div class="header-flex">
    ...
    <form id="searchFormCalonSiswa" class="search-form">
      <input type="text" id="searchInputCalonSiswa" placeholder="Cari nama calon siswa..." />
      <i id="searchIconCalonSiswa" class="fa fa-search"></i>
      <div id="suggestionsCalonSiswa" class="suggestionsCalonSiswa"></div>
...
<div id="paginationCalonSiswa"></div>
